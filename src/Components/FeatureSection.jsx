    ...
    return (
        <div className="relative mt-20 border-b border-neutral-800 min-h-[800px]">
            <div className="text-center">
                <span
                    className="bg-neutral-800 text-orange-500 rounded-full h-6 
        text-sm font-medium px-2 py-1 uppercase"
                ...
                <div className="flex justify-center items-center mt-10 lg:mt-20">
                    ...
                    <span className="bg-gradient-to-r from-orange-500 to-orange-800 text-transparent bg-clip-text text-3xl sm:text-5xl lg:text-6xl ml-2">
                        your code
                    </span>
                </div>
            </div>
            ...
            <div key={index} className="w-full sm:w-1/2 lg:w-1/3">
              <div className="flex">
                ...
                <div>
                    ...
                    <p className="text-md px-2 mb-20 text-neutral-400">{feature.description}</p>
                </div>
              </div>
